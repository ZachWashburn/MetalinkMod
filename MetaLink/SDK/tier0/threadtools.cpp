...
inline int g_nThreadID;
inline void AllocateThreadID( void )
{
...
CThreadEvent::CThreadEvent( bool bManualReset )
{
    ...
    //sertMsg1(m_hSyncObject, "Failed to create event (error 0x%x)", GetLastError() );
#elif defined( _PS3 )
