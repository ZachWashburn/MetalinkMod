...
public:
	...
	// For non-split screen games this will always be zero
		...
		virtual ISPSharedMemory* GetSinglePlayerSharedMemorySpace(const char* szName, int ent_num = 2096) = 0;
		...
		//virtual void RegisterDemoCustomDataCallback(char* szCallbackSaveID, pfnDemoCustomDataCallback pCallback) = 0;
		SUBFUNC();
		SUBFUNC();
		...
		virtual unsigned long GetInputContext(EngineInputContextId_t id) = 0;
...
public:
	...
	virtual void			OnKeyBindingChanged(int buttonCode, char const* pchKeyName, char const* pchNewBinding) = 0;
