...
__forceinline void		_V_memset(void* dest, int fill, int count) {	std::memset(dest, fill, count);}
__forceinline void		_V_memcpy(void* dest, const void* src, int count) { std::memcpy(dest, src, count); };
__forceinline void		_V_memmove( void *dest, const void *src, int count ) { std::memmove(dest, src, count); };
__forceinline int			_V_memcmp(const void* m1, const void* m2, int count) {	return std::memcmp(m1, m2, count);}
__forceinline int			_V_strlen(const char* str) { return std::strlen(str); };
__forceinline int			_V_strnlen(const char* str, int count) { return strnlen(str, count); };
__forceinline void		_V_strcpy(char* dest, const char* src) {	strcpy(dest, src);};
__forceinline char* _V_strrchr(const char* s, char c) { return (char*)strchr(s, c); }
__forceinline int			_V_strcmp(const char* s1, const char* s2) { return strcmp(s1, s2); }
__forceinline int			_V_wcscmp(const wchar_t* s1, const wchar_t* s2) { return wcscmp(s1, s2); }
__forceinline int			_V_stricmp(const char* s1, const char* s2) { throw;/*return stricmp(s1, s2);*/ };
__forceinline char* _V_strstr(const char* s1, const char* search) { return (char*)strstr(s1, search); }
__forceinline char* _V_strupr(char* start) { return strupr(start); }
__forceinline char* _V_strlower(char* start) { throw; }
__forceinline int			_V_wcslen(const wchar_t* pwch) { return wcslen(pwch); }
__forceinline wchar_t* _V_wcslower(wchar_t* start) { throw; }
__forceinline wchar_t* _V_wcsupr(wchar_t* start) { return wcsupr(start); };
...
__forceinline int			V_strncmp(const char* s1, const char* s2, int count) { return strncmp(s1, s2, count); };
...
__forceinline void V_strncpy(char* a1, const char* a2, int a3) { strncpy(a1, a2, a3); }
__forceinline char* V_strncat(char* a1, const char* a2, unsigned int a3, int a4) { throw; /*strncat(a1, a2, a3, a4);*/ }
__forceinline bool V_ExtractFilePath(const char*, char*, int) { throw; }
__forceinline bool V_RemoveDotSlashes(char*, char) { throw; }
