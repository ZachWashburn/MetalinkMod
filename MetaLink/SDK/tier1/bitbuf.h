...
inline unsigned long g_LittleBits[32];
...
inline unsigned long g_BitWriteMasks[32][33];

// (1 << i) - 1
inline unsigned long g_ExtraMasks[33];
...
inline void bf_write::SetOverflowFlag()
{
	...
	{
		//Assert( false );
		DEBUG_OUT_STR("BitBuffer Overflow!\n");
	}
