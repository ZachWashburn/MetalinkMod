...
//	Vector(const Vector &vOther);
	...
	Vector	VectorMin(const Vector &vOther) const;
	Vector	VectorMax(const Vector &vOther) const;
...
// Returns a vector with the min or max in X, Y, and Z.
//-----------------------------------------------------------------------------
inline Vector Vector::VectorMin(const Vector &vOther) const
{
...
inline Vector Vector::VectorMax(const Vector &vOther) const
{
	return Vector(x > vOther.x ? x : vOther.x, 
		y > vOther.y ? y : vOther.y, 
		z > vOther.z ? z : vOther.z);
